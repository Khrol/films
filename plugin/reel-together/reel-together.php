...
require_once RT_PATH . 'includes/class-rt-membership.php';
require_once RT_PATH . 'includes/class-rt-stripe.php';
require_once RT_PATH . 'includes/class-rt-stripe-settings.php';
